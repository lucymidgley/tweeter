const createTweetElement = function(tweet) { //template to insert incoming tweet into html to send to the index file
  //escaping any characters which could be malicious input
  const $tweet = $(`<article>
  <header>
  <div>
